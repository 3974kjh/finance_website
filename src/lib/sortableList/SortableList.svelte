<script lang="ts">
	...
	/**
	 * Add a swap class. Automatically mounts the swap Plugin, sets it to true.pn
	 * @type {string}
	 */
	 ...
	 * */
	export let group: string | Sortable.GroupOptions | undefined = undefined;
	/** Sorting inside list */
	...
	/** className name for the drop placeholder. */
	export let ghostClass = 'sortable-ghost';
	/** className name for the chosen item. */
	export let chosenClass = 'sortable-chosen';
	/** className name for the dragging item. */
	...
	/** className name for the cloned DOM Element when using forceFallback. */
	 ...
	 * */
	export let onChoose: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Element is unchosen
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onUnchoose: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Element dragging started
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onStart: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Element dragging ended
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onEnd: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Element is dropped into the list from another list
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onAdd: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Changed sorting within list
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onUpdate: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Element is removed from the list into another list
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onRemove: ((event:Sortable. SortableEvent) => void) | undefined = undefined;
	/**
	 * Attempt to drag a filtered element
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onFilter: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Called by any change to the list (add / update / remove)
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onSort: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Called when creating a clone of element
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onClone: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
	/**
	 * Event when you move an item in the list or between lists
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onMove:
		| ((evt: Sortable.MoveEvent, originalEvent: Event) => boolean | -1 | 1 | void)
		| undefined = undefined;
	/**
	 * Called when dragging element changes position
	 * @type {fn(event: SortableEvent) => void}
	 * */
	export let onChange: ((event: Sortable.SortableEvent) => void) | undefined = undefined;
...
<div bind:this={list} id={id} class={className} style="{style}" >
	<slot />
</div>